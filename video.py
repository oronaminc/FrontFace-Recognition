...
#원하는 얼굴들의 사진을 업로드 하고 얼굴 인코딩 단계를 거쳐 .npy 파일로 만듭니다
img1_path = 'img/sh.jpg' # me
img1 = read_img(img1_path)
img1_encoded = encode_face(img1)
dic = {}
dic = {'sunghyeon': img1_encoded}
np.save("sh", dic)
...
# 학습된 얼굴파일과 적용시킬 영상을 업로드 합니다.
descs = np.load('img/sh.npy')[()]
